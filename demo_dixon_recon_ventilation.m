function demo_dixon_recon_ventilation(varargin)
...
save([pathstr filesep() name '_gas_recon_old.mat'],'gasVol');

[pathstr,name,ext] = fileparts(dixon_pfile);
niiname = [pathstr filesep() name '_gas_recon_old.nii'];
